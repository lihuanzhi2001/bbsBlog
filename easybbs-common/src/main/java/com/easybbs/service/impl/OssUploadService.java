...
import com.easybbs.service.UploadService;
import com.easybbs.utils.PathUtils;
import lombok.Data;
...
public class OssUploadService implements UploadService {
    @Override
    public ResponseVO uploadImg(MultipartFile img) throws IOException {
        //判断文件类型
        //获取原始文件名
        String originalFilename = img.getOriginalFilename();
        //对原始文件名进行判断
        if (!originalFilename.endsWith(".png")) {
            throw new BusinessException(507, "文件类型错误");
        }
